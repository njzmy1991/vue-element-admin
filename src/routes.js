  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/table', component: () => import('./views/nav1/Table.vue'), name: '表格页' },
        { path: '/form', component: () => import('./views/nav1/Form.vue'), name: '表单页' },
        { path: '/user', component: () => import('./views/nav1/user.vue'), name: '列表页' }
      ]
    },
    {
      path: '/',
